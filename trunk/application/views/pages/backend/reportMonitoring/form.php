...
<section class="content">
    <form class="form-horizontal" method="post" action="<?php echo base_url();?>admin/reportMonitoring/save" onsubmit="return reportMonitoring()"></br></br>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input class="form-control" type="number" id="ar" name="anggaran" value="<?php echo @$detail[0]['anggaran']?>"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<textarea class="form-control" cols="100" rows="5" id="ak" name="ak" style="resize:none;"><?php echo @$detail[0]['aksi']?></textarea>
			</div>
		</div>
		<div class="form-group">
...
<script>
		function reportMonitoring(){
			var no_report = document.getElementById('no_report');
